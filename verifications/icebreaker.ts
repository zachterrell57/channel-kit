...
export const hasIcebreakerHuman: VerificationFunction = async (fid: number): Promise<VerificationResult> => {
...
export const hasIcebreakerVerified: VerificationFunction = async (fid: number): Promise<VerificationResult> => {
...
export const hasIcebreakerQBuilder: VerificationFunction = async (fid: number): Promise<VerificationResult> => {
...
export const hasIcebreakerCoinbaseVerified: VerificationFunction = async (fid: number): Promise<VerificationResult> => {
